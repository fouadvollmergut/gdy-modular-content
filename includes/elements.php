...
/**
 * Handles GDYMC exit hardpreview behavior.
 */
function gdymc_exit_hardpreview()
{
    if (gdymc_hardpreview()):
        echo '<a id="gdymc_exit_hardpreview" href="' .
            esc_url(
                add_query_arg("gdymc_hardpreview", "0", gdymc_current_url())
            ) .
            '">' .
            __("Exit preview", "gdy-modular-content") .
            '<span class="dashicons dashicons-migrate"></span></a>';
    endif;
}
...
/**
 * Handles GDYMC helpers behavior.
 */
...
/**
 * Handles GDYMC dropzone behavior.
 */
function gdymc_dropzone()
{
    if (gdymc_logged()):
        echo '<div id="gdymc_dropzone_overlay" class="gdymc_inside"><div>' .
            __("Drop files here", "gdy-modular-content") .
            "</div></div>";
        ...
        echo '<div id="gdymc_dropzone_headline" class="gdymc_left">' .
            __("Uploader", "gdy-modular-content") .
            "</div>";
        echo '<a class="gdymc_button gdymc_right" href="' .
            get_admin_url("", "upload.php") .
            '" target="blank">' .
            __("Open media library", "gdy-modular-content") .
            "</a>";
        echo '<button class="gdymc_button gdymc_right" id="gdymc_dropzone_trigger">' .
            __("Upload files", "gdy-modular-content") .
            "</button>";
        echo "</div>";
...
/**
 * Handles GDYMC adminbar behavior.
 */
