...
!(function (a) {
      ...
      if (void 0 === c)
        return (
          L.defaultView && L.defaultView.getComputedStyle
            ? (c = L.defaultView.getComputedStyle(a, ""))
  ...
  var t,
    ...
    L = K.document,
    M = K.parseInt,
    N = !!("draggable" in L.createElement("div")),
    O = !1,
    P = Math.abs,
    Q = [].slice,
    R = [],
    S = r(function (a, b, c) {
      if (c && b.scroll) {
        ...
        y &&
          ...
          (f = (P(e.right - j) <= h) - (P(e.left - j) <= h)),
          (g = (P(e.bottom - k) <= h) - (P(e.top - k) <= h))),
          f ||
            g ||
            ((f = (h >= l - j) - (h >= j)),
            (g = (h >= m - k) - (h >= k)),
            (f || g) && (d = K)),
          (H.vx !== f || H.vy !== g || H.el !== d) &&
            ((H.el = d),
            (H.vx = f),
            (H.vy = g),
            clearInterval(H.pid),
            d &&
              (H.pid = setInterval(function () {
                d === K
                  ? K.scrollTo(K.pageXOffset + f * i, K.pageYOffset + g * i)
    ...
    (a.prototype = {
      ...
      _onTapStart: function (a) {
        ...
        if (
          ...
          if (((C = q(h)), "function" == typeof j)) {
            if (j.call(this, a, h, this))
              return k(b, i, "filter", h, c, C), void a.preventDefault();
          } else if (
            j &&
            (j = j.split(",").some(function (a) {
              return (
                (a = d(i, a.trim(), c)),
                a ? (k(b, a, "filter", h, c, C), !0) : void 0
              );
            }))
          )
      ...
      _prepareDragStart: function (a, b, c) {
        ...
        c &&
          ...
          f(i, "mouseup", e._onDrop),
          f(i, "touchend", e._onDrop),
          f(i, "touchcancel", e._onDrop),
          h.delay
            ? (f(i, "mousemove", e._disableDelayedDrag),
              f(i, "touchmove", e._disableDelayedDrag),
              (e._dragStartTimer = setTimeout(d, h.delay)))
            : d());
      },
      ...
      _triggerDragStart: function (a) {
        a
          ? ((F = { target: t, clientX: a.clientX, clientY: a.clientY }),
            this._onDragStart(F, "touch"))
          : N
            ? (f(t, "dragend", this), f(w, "dragstart", this._onDragStart))
      ...
      _dragStarted: function () {
        w &&
          t &&
          (h(t, this.options.ghostClass, !0),
          (a.active = this),
          k(this, w, "start", t, w, C));
      },
      _emulateDragOver: function () {
        if (G) {
          i(u, "display", "none");
          var a = L.elementFromPoint(G.clientX, G.clientY),
            b = a,
      ...
      _onTouchMove: function (a) {
        if (F) {
          var b = a.touches ? a.touches[0] : a,
            c = b.clientX - F.clientX,
            d = b.clientY - F.clientY,
            e = a.touches
              ? "translate3d(" + c + "px," + d + "px,0)"
              : "translate(" + c + "px," + d + "px)";
          (G = b),
            i(u, "webkitTransform", e),
            i(u, "mozTransform", e),
            i(u, "msTransform", e),
            i(u, "transform", e),
            a.preventDefault();
      ...
      _onDragStart: function (a, b) {
        ...
        if (
          ...
          var e,
            ...
            h = i(t);
          (u = t.cloneNode(!0)),
            i(u, "top", g.top - M(h.marginTop, 10)),
            i(u, "left", g.left - M(h.marginLeft, 10)),
            i(u, "width", g.width),
            i(u, "height", g.height),
            i(u, "opacity", "0.8"),
            i(u, "position", "fixed"),
            ...
            i(u, "width", 2 * g.width - e.width),
            i(u, "height", 2 * g.height - e.height),
            "touch" === b
              ? (f(L, "touchmove", this._onTouchMove),
                f(L, "touchend", this._onDrop),
                f(L, "touchcancel", this._onDrop))
              : (f(L, "mousemove", this._onTouchMove),
                f(L, "mouseup", this._onDrop)),
            (this._loopId = setInterval(this._emulateDragOver, 150));
        } else
          c &&
            ((c.effectAllowed = "move"),
            d.setData && d.setData.call(this, c, t)),
            f(L, "drop", this);
        ...
        if (
          ...
          E &&
            ...
            (m
              ...
              : E.pull &&
                k &&
                (E.name === j.name || (k.indexOf && ~k.indexOf(E.name)))) &&
          ...
          if (
            ...
            return (
              b(!0),
              void (v || x ? w.insertBefore(t, v || x) : p || w.appendChild(t))
            );
          if (
            0 === g.children.length ||
            g.children[0] === u ||
            ...
            var q,
              ...
              s = r.right - r.left,
              y = r.bottom - r.top,
              z = /left|right|inline/.test(B.cssFloat + B.display),
              C = c.offsetWidth > t.offsetWidth,
              D = c.offsetHeight > t.offsetHeight,
              F =
                (z ? (a.clientX - r.left) / s : (a.clientY - r.top) / y) > 0.5,
            ...
            H !== !1 &&
              ...
              (q =
                1 === H || -1 === H
                  ? 1 === H
                  : z
                    ? (c.previousElementSibling === t && !C) || (F && C)
                    : (G !== t && !D) || (F && D)),
              q && !G
                ? g.appendChild(t)
                : c.parentNode.insertBefore(t, q ? G : c),
              this._animate(e, t),
              this._animate(r, c));
          }
        }
      ...
      _offUpEvents: function () {
        var a = this.el.ownerDocument;
        g(L, "touchmove", this._onTouchMove),
      ...
      _onDrop: function (b) {
        ...
        clearInterval(this._loopId),
          ...
          clearTimeout(this._dragStartTimer),
          g(L, "drop", this),
          g(L, "mousemove", this._onTouchMove),
          ...
          b &&
            ...
            t &&
              ...
              w !== t.parentNode
                ? ((D = q(t)),
                  k(null, t.parentNode, "sort", t, w, C, D),
                ...
                : (v && v.parentNode.removeChild(v),
                  t.nextSibling !== x &&
                    ((D = q(t)),
                    k(this, w, "update", t, w, C, D),
                    k(this, w, "sort", t, w, C, D))),
              a.active && (k(this, w, "end", t, w, C, D), this.save())),
            (w = t = u = x = v = y = z = F = G = A = B = E = a.active = null));
      },
      handleEvent: function (a) {
        var b = a.type;
        "dragover" === b || "dragenter" === b
          ? t && (this._onDragOver(a), e(a))
