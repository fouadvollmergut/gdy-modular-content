  ...
  function (api, module) {
    ...
    function elementHasNonClassAttributes(el, exceptions) {
      for (var i = 0, len = el.attributes.length, attrName; i < len; ++i) {
        ...
        if (
          !(exceptions && contains(exceptions, attrName)) &&
      ...
      return typeof testEl.isContentEditable == "boolean"
        ...
        : function (node) {
            ...
            return (
              ...
              isEditableElement(node.parentNode)
            );
          };
    })();
    ...
    var getPreviousMergeableTextNode =
        createAdjacentMergeableTextNodeGetter(false),
              ...
              if (positionsToPreserve) {
                for (j = 0; (position = positionsToPreserve[j++]); ) {
                  ...
                  if (
                    ...
                    --position.offset;
                    if (
                      position.offset == firstTextNodeIndex + 1 &&
                      i < len - 1
                    ) {
                      position.node = firstTextNode;
                      position.offset = combinedTextLength;
    ...
    ClassApplier.prototype = {
      ...
      elementHasProperties: function (el, props) {
        ...
        return each(props, function (p, propValue) {
          if (p == "className") {
            return (
              sortClassName(el.className) == applier.elementSortedClassName
            );
      ...
      splitAncestorWithClass: function (
        container,
        offset,
        positionsToPreserve,
      ) {
